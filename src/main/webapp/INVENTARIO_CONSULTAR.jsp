                                ...
                                <table class="table">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><%=result.getString("precio_venta")%></td>
                                            <td><%=result.getString("provedor")%></td>
                                            <td><%=result.getString("fecha_orden")%></td>
                                            <td><a href="PRODUCTO.jsp?admin=<%=user%>&producto=<%=result.getString("cod_producto")%>"><button type="button" class="btn btn-outline-info m-2">DETALLES</button></a></td>
                                        </tr>
                                        <%  }}catch (SQLException error) {
