                ...
                <div class="navbar-nav w-100">
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu bg-transparent border-0">
                            ...
                            <a href="PERSONAL.jsp?admin=admin=<%=user%>" class="dropdown-item">AGREGAR</a>
                        </div>
                    </div>
                                ...
                                <table class="table">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><%=result.getString("turno_empleado")%></td>
                                            <td><%=result.getString("horas_trabajo")%></td>
                                            <td><%=result.getString("evaluación")%></td>
                                            <td><a href="TRABAJADOR.jsp?admin=<%=user%>&id=<%=result.getString("id_empleado")%>"><button type="button" class="btn btn-outline-info m-2">DETALLES</button></a></td>
                                        </tr>
                                        <%  }}catch (SQLException error) {
