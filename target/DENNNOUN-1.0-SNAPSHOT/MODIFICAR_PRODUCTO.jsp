                ...
                <div class="navbar-nav w-100">
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu bg-transparent border-0">
                            ...
                            <a href="INVENTARIO.jsp?admin=admin=<%=user%>" class="dropdown-item">AGREGAR</a>
                        </div>
                    </div>
                ...
                try{
                    ...
                    <div style="margin-left: auto; margin-right: auto; margin-top: 10%" class="col-sm-12 col-xl-6">
                        <div class="bg-secondary rounded h-100 p-4">
                            ...
                            <form action="MODIFICAR_PRODUCTO2.jsp?admin=<%=user%>&producto=<%=cod%>" method="post" name="form">
                                <div class="mb-3">
                                    <label for="exampleInputEmail1" class="form-label">NOMBRE</label>
                                    <input type="text" value="<%=result.getString("nombre_producto")%>" placeholder="PRODUCTO" name="nombre" class="form-control" id="exampleInputEmail1"
                                        aria-describedby="emailHelp">
                                    <br>
                                    
                                    <input style="width: 45%; float: left" value="<%=result.getString("cantidad_producto")%>" placeholder="CANTIDAD" name="cantidad" type="number" class="form-control" id="exampleInputEmail1"
                                        aria-describedby="emailHelp">
                                
                                    
                                    <input style="width: 45%; float: right " value="<%=result.getString("precio_compra")%>" placeholder="COSTO" name="costo" type="number" class="form-control" id="exampleInputEmail1"
                                        aria-describedby="emailHelp">
                                    ...
                                    <input style="width: 45%; float: left" value="<%=result.getString("provedor")%>" placeholder="PROVEDOR" name="provedor" type="text" class="form-control" id="exampleInputEmail1"
                                        aria-describedby="emailHelp">
                                
                                    
                                    <input style="width: 45%; float: right " value="<%=result.getString("precio_venta")%>" placeholder="PRECIO" name="precio" type="number" class="form-control" id="exampleInputEmail1"
                                        aria-describedby="emailHelp">
