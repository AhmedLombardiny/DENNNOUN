        ...
        <div class="content">
            ...
            <div class="col-sm-12 col-xl-6">
                <form action="" method="post" name="form">
                        <div class="bg-secondary rounded h-100 p-4">
                            ...
                            <div class="form-floating mb-3">
                                <input type="number" name="Monto"class="form-control" id="floatingPassword"
                                    placeholder="Password">
                                <label for="floatingPassword">Monto</label>
                            </div>
                            <div class="form-floating mb-3">
                                <input type="text"name="Concepto" class="form-control" id="floatingPassword"
                                    placeholder="Password">
                                <label for="floatingPassword">Concepto</label>
                            </div>
                            <div class="form-floating mb-3">
                                <select class="form-select" name="Franquicia"id="floatingSelect"
            ...
            <div class="container-fluid pt-4 px-4">
                <div class="row g-4">
                    <div class="col-12">
                        <div class="bg-secondary rounded h-100 p-4">
                            <h6 class="mb-4">Personal de la Empresa</h6>
