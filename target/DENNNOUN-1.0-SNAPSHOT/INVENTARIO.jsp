        ...
        <div class="content">
            ...
            <div style="margin-left: auto; margin-right: auto; margin-top: 10%" class="col-sm-12 col-xl-6">
                        <div class="bg-secondary rounded h-100 p-4">
                            ...
                            <form action="AGREGAR_PRODUCTO.jsp?admin=<%=user%>" method="post" name="form">
                                <div class="mb-3">
                                    <label for="exampleInputEmail1" class="form-label">NOMBRE</label>
                                    <input type="text" placeholder="PRODUCTO" name="producto" class="form-control" id="exampleInputEmail1"
                                        aria-describedby="emailHelp">
                                    <br>
                                    
                                    <input style="width: 45%; float: left" placeholder="CANTIDAD" name="cantidad" type="number" class="form-control" id="exampleInputEmail1"
                                        aria-describedby="emailHelp">
                                
                                    
                                    <input style="width: 45%; float: right " placeholder="COSTO" name="costo" type="number" class="form-control" id="exampleInputEmail1"
                                        aria-describedby="emailHelp">
                                    ...
                                    <input style="width: 45%; float: left" placeholder="PROVEDOR" name="provedor" type="text" class="form-control" id="exampleInputEmail1"
                                        aria-describedby="emailHelp">
                                
                                    
                                    <input style="width: 45%; float: right " placeholder="PRECIO" name="precio" type="number" class="form-control" id="exampleInputEmail1"
                                        aria-describedby="emailHelp">
                ...
                try{
                    ...
                    result = stat.executeQuery("select*from productos");
                                ...
                                <table class="table">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><%=result.getString("cantidad_producto")%></td>
                                            <td><%=result.getString("precio_compra")%></td>
